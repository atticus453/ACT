...
class PickAndStackAndTransferPolicy(BasePolicy):
     ...
     def generate_trajectory(self, ts_first):
        ...
        self.right_trajectory = [
            ...
            #{"t": 200, "xyz": red_box_xyz + np.array([0, 0, +0.4]), "quat": right_gripper_pick_quat.elements, "gripper": 1},  # go down to red box
            #{"t": 300, "xyz": red_box_xyz + np.array([0, 0, +0.2]), "quat": right_gripper_pick_quat.elements, "gripper": 0},  # close gripper
            ...
            {"t": 400, "xyz": init_mocap_pose_right[:3], "quat": init_mocap_pose_right[3:], "gripper": 0},  # initial position
        ]
        ...
        self.left_trajectory = [
            ...
            {"t": 100, "xyz": green_box_xyz + np.array([0, 0, 0.3]), "quat": np.array([0.707, 0.707, 0, 0]), "gripper": 1},  # to green box z+0.3 
            {"t": 150, "xyz": green_box_xyz + np.array([0, 0, 0.2]), "quat": np.array([0.707, 0.707, 0, 0]), "gripper": 1},  # to green box z+0.2
            {"t": 200, "xyz": green_box_xyz + np.array([0, 0, 0.1]), "quat": np.array([0.707, 0.707, 0, 0]), "gripper": 1},  # to green box z+0.1
            {"t": 250, "xyz": green_box_xyz + np.array([0, 0, 0.01]), "quat": np.array([0.707, 0.707, 0, 0]), "gripper": 1}, # to green box z+0.01
            {"t": 300, "xyz": green_box_xyz + np.array([0, 0, 0.01]), "quat": np.array([0.707, 0.707, 0, 0]), "gripper": 0}, # close gripper
            {"t": 350, "xyz": green_box_xyz + np.array([0, 0, 0.1]), "quat": np.array([0.707, 0.707, 0, 0]), "gripper": 0},  # to green box z+0.1
            {"t": 375, "xyz": green_box_xyz + np.array([0, 0, 0.3]), "quat": np.array([1, 0, 0, 0]), "gripper": 0},  # to green box z+0.2
            {"t": 400, "xyz": green_box_xyz + np.array([0, 0, 0.5]), "quat": np.array([1, 0, 0, 0]), "gripper": 0}   # to green box z+0.3
